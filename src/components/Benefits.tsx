  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div className="absolute w-96 h-96 -bottom-48 -left-48 bg-secondary rounded-full mix-blend-multiply filter blur-xl animate-pulse delay-1000" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {benefits.map((benefit, index) => (
            ...
            >
              <div className="h-full p-8 bg-primary/5 rounded-2xl transition-all duration-300 hover:bg-primary hover:shadow-xl hover:-translate-y-1">
                <div className={`w-12 h-12 rounded-xl bg-primary text-primary-foreground flex items-center justify-center mb-6 transition-all duration-300 group-hover:bg-white/10 group-hover:text-white transform ${
                ...
                <p className={`text-sm mb-6 transition-colors duration-300 ${
                  hoveredIndex === index ? "text-primary-foreground/90" : "text-neutral-600"
                }`}>
                  {benefit.description}
                </p>
